...
class AnsibleTestInfraCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        central_station_group = "central_stations"
        cls.central_station = testinfra.get_host(
            f"ansible://{ central_station_group }?ansible_inventory={os.environ.get('MOLECULE_INVENTORY_FILE')}")
